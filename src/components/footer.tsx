...
export function Footer() {
  return (
    <footer style={{ background:'var(--navy)', borderTop:'1px solid rgba(92,225,230,0.08)', marginTop:'auto' }}>
      <style>{`
        .footer-link { display:block; font-size:0.82rem; color:rgba(232,232,240,0.5); text-decoration:none; margin-bottom:0.4rem; transition:color 0.15s; }
        .footer-link:hover { color:#5CE1E6; }
